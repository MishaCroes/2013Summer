...
- (void) initTextView :(UIView*) view {
    ...
    textView = [[UITextView alloc] initWithFrame:CGRectMake((W - W * 0.5) * 0.5, 0.0 * H, W * 0.5, H * 0.6)];
    [textView setFont:[UIFont fontWithName:@"ArialMT" size:64]];
...
- (void) updateVisual :(int)swipe {
    switch (swipe) {
        ...
        case EAST:
            ...
            break;
        case SOUTHEAST:
            imgView.image = [UIImage imageNamed:@"NM.png"];
            break;
        case SOUTH:
