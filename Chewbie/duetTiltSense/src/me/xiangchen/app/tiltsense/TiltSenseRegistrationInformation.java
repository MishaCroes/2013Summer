...
public class TiltSenseRegistrationInformation extends RegistrationInformation {
	final Context mContext;

	protected TiltSenseRegistrationInformation(Context context) {
		if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                TiltSenseExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == TiltSenseExtension.getSupportedControlWidth(mContext) && height == TiltSenseExtension
