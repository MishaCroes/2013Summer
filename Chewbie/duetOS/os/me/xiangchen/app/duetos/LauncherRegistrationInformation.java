...
public class LauncherRegistrationInformation extends RegistrationInformation {
	final Context mContext;

	protected LauncherRegistrationInformation(Context context) {
		if (context == null) {
	...
	public ContentValues getExtensionRegistrationConfiguration() {
		...
		values.put(Registration.ExtensionColumns.EXTENSION_KEY,
				LauncherExtensionService.EXTENSION_KEY);
	...
	public boolean isDisplaySizeSupported(int width, int height) {
		return ((width == LauncherExtension.getSupportedControlWidth(mContext) && height == LauncherExtension
