...
public class HandSenseRegistrationInformation extends RegistrationInformation {
	final Context mContext;

	protected HandSenseRegistrationInformation(Context context) {
		if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                HandSenseExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == HandSenseExtension.getSupportedControlWidth(mContext) && height == HandSenseExtension
