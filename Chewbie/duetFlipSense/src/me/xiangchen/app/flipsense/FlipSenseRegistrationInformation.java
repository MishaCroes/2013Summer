...
public class FlipSenseRegistrationInformation extends RegistrationInformation {
	final Context mContext;

	protected FlipSenseRegistrationInformation(Context context) {
		if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                FlipSenseExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == FlipSenseExtension.getSupportedControlWidth(mContext) && height == FlipSenseExtension
