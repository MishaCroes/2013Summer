...
public class EERRegistrationInformation extends RegistrationInformation {
	final Context mContext;

	protected EERRegistrationInformation(Context context) {
		if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                EERExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == EERExtension.getSupportedControlWidth(mContext) && height == EERExtension
