...
public class BumpSenseRegistrationInformation extends RegistrationInformation {
	
	final Context mContext;

	protected BumpSenseRegistrationInformation(Context context) {
		if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                BumpSenseExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == BumpSenseExtension.getSupportedControlWidth(mContext) && height == BumpSenseExtension
