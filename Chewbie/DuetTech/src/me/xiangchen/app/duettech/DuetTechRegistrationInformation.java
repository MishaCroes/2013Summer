...
public class DuetTechRegistrationInformation extends RegistrationInformation {
final Context context;
	
	protected DuetTechRegistrationInformation(Context context) {
		if (context == null) {
	...
	public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                DuetTechExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == DuetTechExtension.getSupportedControlWidth(context) && height == DuetTechExtension
