...
public class ChewbieRegistrationInformation extends RegistrationInformation {

	final Context context;

	protected ChewbieRegistrationInformation(Context context) {
		if (context == null) {
	...
	public ContentValues getExtensionRegistrationConfiguration() {
		...
		String configurationText = context
		...
		values.put(Registration.ExtensionColumns.EXTENSION_KEY,
				ChewbieExtensionService.EXTENSION_KEY);
	...
	public boolean isDisplaySizeSupported(int width, int height) {
		return ((width == ChewbieExtension.getSupportedControlWidth(context) && height == ChewbieExtension
