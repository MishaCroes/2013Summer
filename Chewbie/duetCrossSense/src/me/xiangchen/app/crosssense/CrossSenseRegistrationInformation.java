...
import me.xiangchen.app.crosssense.R;
...
public class CrossSenseRegistrationInformation extends RegistrationInformation {
	final Context mContext;

	protected CrossSenseRegistrationInformation(Context context) {
		if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                CrossSenseExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == CrossSenseExtension.getSupportedControlWidth(mContext) && height == CrossSenseExtension
