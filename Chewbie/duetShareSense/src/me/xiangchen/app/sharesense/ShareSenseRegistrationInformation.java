...
public class ShareSenseRegistrationInformation extends RegistrationInformation {
	final Context mContext;

	protected ShareSenseRegistrationInformation(Context context) {
		if (context == null) {
	...
	public ContentValues getExtensionRegistrationConfiguration() {
		...
		values.put(Registration.ExtensionColumns.EXTENSION_KEY,
				ShareSenseExtensionService.EXTENSION_KEY);
	...
	public boolean isDisplaySizeSupported(int width, int height) {
		return ((width == ShareSenseExtension
				.getSupportedControlWidth(mContext) && height == ShareSenseExtension
