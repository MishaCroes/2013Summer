...
public class RotateSenseExtension extends ControlExtension {

	public final static int WATCHACCELFPS = 10;
	public final static String LOGTAG = "RotateSense";
	...
	public RotateSenseExtension(Context context, String hostAppPackageName) {
