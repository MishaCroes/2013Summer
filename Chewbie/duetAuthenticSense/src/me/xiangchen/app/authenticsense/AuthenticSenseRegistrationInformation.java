...
public class AuthenticSenseRegistrationInformation extends RegistrationInformation {
	final Context mContext;
	
	protected AuthenticSenseRegistrationInformation(Context context) {
		if (context == null) {
	...
	public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                AuthenticSenseExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == AuthenticSenseExtension.getSupportedControlWidth(mContext) && height == AuthenticSenseExtension
