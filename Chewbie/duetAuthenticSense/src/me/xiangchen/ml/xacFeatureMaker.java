...
import me.xiangchen.app.authenticsense.AuthenticSense;
import me.xiangchen.app.authenticsense.AuthenticSenseExtension;
...
//		Log.d(tag, "The " + (pntrEntry+1) + "th entry added");
	...
	public static void sendOffData(int numToSend, String[] classLabels) {
		...
		int numToSendWatch = numToSendPhone * AuthenticSenseExtension.WATCHACCELFPS / AuthenticSense.PHONEACCELFPS;
