...
public class TouchSenseRegistrationInformation extends RegistrationInformation {
	
	final Context mContext;

	protected TouchSenseRegistrationInformation(Context context) {
		if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                TouchSenseExtensionService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return ((width == TouchSenseExtension.getSupportedControlWidth(mContext) && height == TouchSenseExtension
